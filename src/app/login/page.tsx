                ...
                <Card className="w-full max-w-md border-none shadow-2xl bg-card/50 backdrop-blur-xl">
                    <CardHeader className="text-center space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <CardDescription className="text-lg">
                                Sign in to GreenBuild AI to access your sustainability tools.
                            </CardDescription>
                        </div>
                    </CardHeader>
                    <CardContent className="space-y-6 pt-4">
                        <Button
                            ...
                            variant="outline"
                            className="w-full h-14 text-lg font-semibold flex items-center justify-center gap-3 hover:bg-muted/50 transition-all border-2"
                        >
